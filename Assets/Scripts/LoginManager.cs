...
public class LoginManager : MonoBehaviour
{
    ...
    IEnumerator GetJsonList()
    {
        ...
        using (UnityWebRequest queryBlueprints = UnityWebRequest.Post("http://161.53.19.97:5000/graphql", postCont))
        {
            byte[] jsonToSend = new System.Text.UTF8Encoding().GetBytes(postCont);
    ...
    IEnumerator GetJSONFile(string id)
    {
        ...
        using (UnityWebRequest queryBlueprint = UnityWebRequest.Post("http://161.53.19.97:5000/graphql", postCont))
        {
            byte[] jsonToSend = new System.Text.UTF8Encoding().GetBytes(postCont);
